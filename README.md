...
`liquibase --url="jdbc:postgresql://localhost:5432/avenirs_referentiel_formation" --username="postgres" --password="postgres" --driver="org.postgresql.Driver" --defaultSchemaName="dev" --changeLogFile="./src/main/resources/db/changelog/001-create-tables.yaml" generateChangeLog  --author="Dugat"`